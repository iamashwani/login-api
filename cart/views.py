...
from .serializers import ProfileSerializer, VerifyOTPSerializer, UserProfileChangeSerializer, walletserializer, \
    walletserializer_add, walletserializer_deduct
    ...
    def post(self, request):
        ...
        if data is not None:
            ...
            if serializer.is_valid(raise_exception=True):
                ...
                content = {'Status': True, 'Message': 'Success', 'mobile': instance.mobile, 'otp': instance.otp,
                           'name': instance.name, 'username': instance.username, 'logo': instance.logo,
                           'profile_url': instance.profile_url, 'id': instance.id}
