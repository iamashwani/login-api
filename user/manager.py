from cart.models import ReferralRelationship, ReferralCode
import secrets
from django.contrib.auth.models import BaseUserManager

class UserManager(BaseUserManager):
    def create_user(self, username, mobile,referral_token=None):
        ...
        if not usages_token:
            # create user
            user = self.model(
                username=username, mobile=mobile, referral_token=referral_token)
            user.save()
